...
def goal_list(request):
    courses = Course.objects.filter(user=request.user).prefetch_related('goals')
    courses_with_goals = [(c, list(c.goals.all())) for c in courses]
    return render(request, 'tracker/goal_list.html', {'courses_with_goals': courses_with_goals})
